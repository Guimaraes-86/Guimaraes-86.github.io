...
- **⚡ Repositório de Estudos Acadêmicos**  
  *Centralização de exercícios, algoritmos e códigos desenvolvidos durante as aulas da graduação superior em ADS.*  

- **🚀 Meu Portfólio Profissional**  

# 4. ✦ Habilidades
- **Fundamentos:** Lógica de Programação e Construção de Algoritmos.
- **Teoria:** Arquitetura de Computadores e Sistemas Operacionais.
- **Soft Skills:** Resolução de problemas complexos, tomada de decisão sob pressão, disciplina militar, resiliência e facilidade para trabalhar em equipes multidisciplinares.
...
# 6. ✉ Contato
- **E-mail:** [rodrigosilvaicm@outlook.com]
- **LinkedIn:** [www.linkedin.com/in/rodrigo-guimarães-89167272]
